<footer class="footer -type-1 bg-dark-5 -green-links">
    <div class="scroll-up" id="scroll" style="display: none">
        <a href="#" class="button " id="scroll-up-button">
            ...
            <div class="row y-gap-20 justify-between items-center">
                <div class="col-auto">
                    <div class="footer-header__logo">
                        <img style="width: 25%;" src="img/logo.png" alt="logo">
                    </div>
                </div>
                <div class="col-auto">
            ...
            <div class="row y-gap-30">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="footer-columns-form">
                        ...
                        <form action="https://creativelayers.net/themes/Panchee-html/post">
            ...
            <div class="row justify-between items-center y-gap-20">
                <div class="col-auto">
                    <div class="d-flex items-center h-100 text-white">
                        © 2022 Panchee. All Right Reserved.
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div class="d-flex x-gap-20 y-gap-20 items-center flex-wrap">
                        ...
                        <div>
                            <a href="#" class="button px-30 h-50 -green-5 rounded-200 text-white">
